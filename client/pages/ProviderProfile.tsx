...
const ProviderProfile: React.FC = () => {
  ...
  const provider = {
    ...
    avatar:
      "https://api.builder.io/api/v1/image/assets/TEMP/9db2454a3d7cf43a580bcfb75d1ef94e93fd9780?width=150",
    overallRating: 4.5,
    services: [
      {
        id: 1,
    ...
    for (let i = 1; i <= 5; i++) {
      if (i <= rating) {
        ...
        stars.push(
          <svg
            key={i}
            className={`${starSize} fill-yellow-400`}
            viewBox="0 0 24 24"
          >
    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="bg-purple-700 h-20 relative">
        ...
        <div className="relative z-10 flex items-center justify-between px-3 pt-4">
          <button onClick={() => setIsMenuOpen(true)} className="w-10 h-12">
            <img
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white h-19 flex items-center justify-around px-4 border-t">
        <button onClick={goToHome} className="flex flex-col items-center">
          ...
          />
          <span className="text-gray-600 font-['Roboto'] text-sm font-light">
            Inicio
          </span>
        </button>
        ...
        <button onClick={goToChat} className="flex flex-col items-center">
          ...
          />
          <span className="text-gray-600 font-['Roboto'] text-sm font-light text-center">
            Chat
          </span>
        </button>
